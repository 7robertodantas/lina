...
Set the credentials in your `docker-compose.yml` or as environment variables:
...
The Mosquitto configuration is managed via environment variables in `docker-compose.yml`:
