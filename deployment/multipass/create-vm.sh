...
echo ""
echo "# Default: Ansible cross-compiles on your Mac (brew install go)."
echo "# Optional: lina_build_goarch=arm64 is already the Pi / Multipass default in group_vars."
echo ""
