...
# Restart services
docker-compose -f docker-compose.edge.yml restart mosquitto device smartmeter
```
...
- Update port mappings in `docker-compose.edge.yml` if needed
...
## Minimal Deployment (Just docker-compose.edge.yml)

If you only want to copy `docker-compose.edge.yml`, you have two options:
